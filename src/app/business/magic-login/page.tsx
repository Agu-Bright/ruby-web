...
export default function BusinessMagicLoginPage() {
  return <Suspense fallback={<main className="flex min-h-screen items-center justify-center bg-gray-50 p-6"><p className="text-sm text-gray-500">Preparing secure sign-in…</p></main>}><MagicLoginContent /></Suspense>;
}

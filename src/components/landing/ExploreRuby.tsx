...
const articles = [
  ...
  },
  {
    ...
    title:
      "Hidden Gems: Discover Africa's Best Kept Secrets for Adventurous Travelers",
    author: "Amara Obi",
    time: "5 days ago",
    likes: 142,
    comments: 28,
  },
  {
    ...
    title:
      "How to Travel Nigeria Like a Local: Insider Tips and Cultural Etiquette",
    author: "Chidi Eze",
    time: "1 week ago",
    likes: 203,
    comments: 41,
...
function CountdownUnit({ value, label }: { value: number; label: string }) {
  return (
    <div className="flex flex-col items-center">
      ...
      <span className="mt-1.5 text-[9px] sm:text-[10px] text-white/60 uppercase tracking-widest font-medium">
        {label}
      </span>
    </div>
  );
  ...
  return (
    <section className="py-16 sm:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          {/* Outer wrapper — strings positioned relative to this */}
          <div className="relative">
            {/* String decoration — left, OUTSIDE the red box */}
            <div
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-[50%] w-16 sm:w-24 lg:w-32 h-48 sm:h-56 lg:h-64 bg-contain bg-no-repeat bg-center -scale-x-100 z-20"
              style={{ backgroundImage: "url(/images/string1.png)" }}
              aria-hidden="true"
            />

            {/* String decoration — right, OUTSIDE the red box */}
            <div
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-[50%] w-16 sm:w-24 lg:w-32 h-48 sm:h-56 lg:h-64 bg-contain bg-no-repeat bg-center z-20"
            ...
            {/* Red container */}
            <div
              className="relative rounded-[2rem] sm:rounded-[3rem] overflow-hidden px-6 sm:px-10 lg:px-16 py-12 sm:py-16"
              style={{
                background:
            ...
            >
              ...
              <div className="blur-[2px] opacity-30 select-none pointer-events-none">
                <div className="text-center mb-10">
                  <h2
                    className="font-playfair text-2xl sm:text-3xl lg:text-4xl font-bold text-white uppercase"
                    style={{ fontVariant: "small-caps" }}
                  >
                    Explore Ruby+
                  </h2>
                  <p className="mt-3 text-xs sm:text-sm text-white/60 max-w-xl mx-auto leading-relaxed">
                    Our blog is a trove of travel wisdom, filled with tips,
                    news, and stories to inspire your next expedition.
                  </p>
                </div>
                  ...
                  {articles.slice(0, 3).map((article) => (
                    ...
                    >
                      ...
                      <div className="px-1 pb-1">
                        <h3 className="text-sm font-bold text-ruby-black leading-snug mb-4 line-clamp-3">
                          {article.title}
                        </h3>
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-xs font-semibold text-ruby-black">
                              {article.author}
                            </p>
                          ...
                          <div className="flex items-center gap-3">
                            <div className="flex items-center gap-1">
                              <svg
                                className="w-4 h-4 text-ruby-red"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                              >
              ...
              <div className="absolute inset-0 z-10 flex items-center justify-center">
                <div className="text-center px-4">
                  ...
                  <div className="flex items-center justify-center gap-2.5 sm:gap-4">
                    ...
                    <div className="text-xl font-bold text-white/30 mt-[-16px]">
                      :
                    </div>

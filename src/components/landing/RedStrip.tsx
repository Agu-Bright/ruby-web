        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="sm:hidden bg-white rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.10)] p-4 space-y-3">
            <div className="flex items-center gap-3 px-4 py-3 bg-gray-50 rounded-xl">
              <svg className="w-5 h-5 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
              <input
                type="text"
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            <h2 className="font-playfair text-xl sm:text-2xl lg:text-3xl font-bold text-white italic leading-snug">
              For Global Diaspora, Tourists &amp; Local Residents.
            </h2>

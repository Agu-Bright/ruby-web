...
export function useBusinessWallets(){const {business}=useBusinessAuth();const id=business?._id??'';const f=useCallback(()=>api.businessWallets.list(id),[id]);return useBusinessQuery(f,[id],{enabled:!!id})}
